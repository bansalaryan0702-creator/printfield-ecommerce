...
export function Home() {
  ...
  return (
    <Layout>
      <SEO 
        title="Printfield - Premium Custom Printing & Packaging Solutions" 
        description="Premium online printing services. Custom apparel, business stationery, drinkware, and promotional materials. High-quality print on demand with fast shipping."
        canonicalUrl="/"
      />
      <div ref={containerRef} className="bg-white text-slate-900 min-h-screen selection:bg-purple-500 selection:text-white font-sans overflow-hidden">
        ...
        <section className="relative min-h-[calc(100vh-140px)] flex items-center justify-start overflow-hidden py-20">
          ...
          >
            ...
            >
              <Link to="/categories" className="group relative px-8 py-4 bg-slate-900 text-white font-bold uppercase tracking-wider rounded-full overflow-hidden shadow-lg shadow-slate-900/10 hover:shadow-purple-500/25 transition-all">
        ...
        <section className="py-32 px-6 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-6">
            <div>
              <h2 className="text-5xl md:text-7xl font-black tracking-tighter uppercase mb-4 text-slate-900 leading-[0.9]">
                Core <br />
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div>
              <h2 className="text-5xl md:text-7xl font-black tracking-tighter uppercase mb-6 text-slate-900">Trending <br/> <span className="text-slate-400">Now</span></h2>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-6">
              <div>
                ...
                <h2 className="text-5xl md:text-7xl font-black tracking-tighter uppercase mt-2 mb-4 text-slate-900 leading-[0.9]">
                  Catered <br />
