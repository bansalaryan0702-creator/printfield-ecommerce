...
const target1 = `                <div className="flex gap-2 isolate relative z-10">
                  <input 
                    type="url" 
                    value={importUrl} 
...
const replacement1 = `                <div className="flex gap-2 isolate relative z-10">
                  <input 
                    type="url" 
                    value={importUrl} 
                    onChange={e => setImportUrl(e.target.value)}
                  ...
                  <Button onClick={() => { setBatchCategoryUrl(importUrl); handleBatchCategoryImport(); }} disabled={isImporting || isBatchImporting || !importUrl} className="shrink-0 gap-2">
